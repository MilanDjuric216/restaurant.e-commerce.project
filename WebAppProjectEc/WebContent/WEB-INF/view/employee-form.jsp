...
<div class="wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" modelAttribute="employee" action="employee-save">
              	<form:hidden path="id"/>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label>Role</label>
                        <form:input type="text" class="form-control" placeholder="Enter role" path="role"/>
                      </div>
                      <div class="form-group">
                        <label>Description</label>
                        <form:input type="text" class="form-control" placeholder="Enter description" path="description"/>
                      </div>
					  <div class="form-group">
                        <label>Image</label>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="">Projecat</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
