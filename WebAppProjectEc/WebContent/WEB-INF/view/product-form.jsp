        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" modelAttribute="product" action="product-save">
              	<form:hidden path="id"/>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
					...
					<div class="form-group">
                      ...
                      <div class="form-check">
	                    <form:checkbox class="form-check-input" path="isOnMainPage"/>
	                    <label class="form-check-label">Show On Main Page</label>
	                  </div>
	                  
	                  <div class="form-check">
	                    <form:checkbox class="form-check-input" path="isOnMenu"/>
