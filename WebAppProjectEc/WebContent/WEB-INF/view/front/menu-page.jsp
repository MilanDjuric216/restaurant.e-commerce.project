	                ...
	                <div class="container">
	                    <div>
	                        <article class="headingSecond">
	                            <img src="${category.image}" class="center-block"/>
	                            <h2 class="text-center">${category.name}</h2>
	                            <p class="text-center text-uppercase"><img src="img/doubleLine.png"/>  ${category.description}  <img src="img/doubleLine.png" alt="decoration"/></p>
	                        </article>
	                    </div>
	
	                    <article class="menuProducts">
	                    	<c:forEach items="${category.productsOnMainPage}" var="product">
		                        <div class="row">
		                            <div class="col-sm-6">
		                                <div class="row">
